...
@section("title","Edit Our Menu Item")
@section("content")
    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{url('ourmenuitem/list')}}">Datatable </a></li>
      ...
      <div class="col-md-8 offset-2">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Edit / Modify Our Menu Item</h3>
            <div class="card-tools">
              <ul class="pagination pagination-sm float-right">
                ...
                <li class="page-item">
                    <a class="page-link bg-primary" href="{{url('ourmenuitem/list')}}"> 
                        Data 
                        <i class="fas fa-table"></i>
                    </a>
                </li>
                <li class="page-item">
                  <a class="page-link  bg-primary" target="_blank" href="{{url('ourmenuitem/export/pdf')}}">
                    <i class="fas fa-file-pdf" data-toggle="tooltip" data-html="true"title="Pdf"></i>
                  </a>
                </li>
                <li class="page-item">
                  <a class="page-link  bg-primary" target="_blank" href="{{url('ourmenuitem/export/excel')}}">
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form action="{{url('ourmenuitem/update/'.$dataRow->id)}}" method="post" enctype="multipart/form-data">
          {{csrf_field()}}
        ...
        <option value="">Please select</option>
            ...
            <div class="card-footer">
              ...
              <a class="btn btn-danger" href="{{url('ourmenuitem/edit/'.$dataRow->id)}}">
