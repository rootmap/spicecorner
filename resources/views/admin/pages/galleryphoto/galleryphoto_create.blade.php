...
@section("title","Create New Gallery Photo")
@section("content")
    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{url('galleryphoto/list')}}">Gallery Photo Data</a></li>
              <li class="breadcrumb-item active">Create New Gallery Photo</li>
            </ol>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-md-8 offset-2">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Create New Gallery Photo</h3>
                ...
                <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Photo Title" id="photo_title" name="photo_title">
                      </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <!-- <label for="customFile">Choose Photo</label> -->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                  <label>Choose Photo Status</label>
