            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active">Gallery Photo Data</li>
                </ol>
              </div>
            </div>
            <div class="row">
            ...
            <div class="col-12">
              ...
              <div class="card">
                ...
                <div class="card-header">
                  <h3 class="card-title">Gallery Photo Data</h3>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">Photo Title</th>
                            ...
                            @foreach($dataRow as $row)  
                                <tr>
                                    ...
                                    <td class="text-center">
                                      @isset($row->photo)
                                          @if (!empty($row->photo))
                                              <img height="100" src="{{asset('upload/galleryphoto/small/'.$row->photo)}}" />
                                          @endif
                                      @endisset
                                    </td>
