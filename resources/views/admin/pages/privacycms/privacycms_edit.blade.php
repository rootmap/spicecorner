...
@section("title","Edit Privacy CMS")
@section("content")
    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active">Update Privacy CMS</li>
            </ol>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-md-8 offset-2">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Edit / Modify Privacy CMS</h3>
        </div>
          <!-- /.card-header -->
          <!-- form start -->
          <form action="{{url('privacycms/update/'.$dataRow->id)}}" method="post" enctype="multipart/form-data">
          {{csrf_field()}}
                ...
                <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" rows="23"  placeholder="Enter Description" id="description" name="description"><?php 
        ...
        <option value="">Please select</option>
            ...
            <div class="card-footer">
              ...
              <a class="btn btn-danger" href="{{url('privacycms/edit/'.$dataRow->id)}}">
