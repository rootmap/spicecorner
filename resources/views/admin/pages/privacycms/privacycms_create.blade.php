...
@section("title","Create New Privacy CMS")
@section("content")
    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active">Create New Privacy CMS</li>
            </ol>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-md-8 offset-2">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Create New Privacy CMS</h3>            
        </div>
          <!-- /.card-header -->
          <!-- form start -->
          <form action="{{url('privacycms')}}" method="post" enctype="multipart/form-data">
          {{csrf_field()}}
        ...
        <option value="">Please select</option>
            ...
            <div class="card-footer">
              ...
              <a class="btn btn-danger" href="{{url('privacycms/create')}}"><i class="far fa-times-circle"></i> Reset</a>
            </div>
          </form>
        </div>
        <!-- /.card -->
