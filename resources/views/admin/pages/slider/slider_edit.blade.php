                ...
                <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <?php 
                        if(isset($dataRow->photo_title)){
                            ?>
                            value="{{$dataRow->photo_title}}" 
                            <?php 
                        }
                        ?>
                        
                        class="form-control" placeholder="Enter Photo Title" id="photo_title" name="photo_title">
                      </div>
                    </div>
                </div>
                            ...
                            <div class="col-md-6">
                                @if(isset($dataRow->photo))
                                    @if(!empty($dataRow->photo))
                                        <img class="img-thumbnail" src="{{url('upload/slider/'.$dataRow->photo)}}" width="150">
                                    @endif
                                @endif
                            </div>
                        </div>
