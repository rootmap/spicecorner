...
class CategoryController extends Controller
{
        ...
        $tab=Customer::select('id','name','address','phone','email','last_invoice_no','created_at')
                     ...
                     ->when($search, function ($query) use ($search) {
                        $query->where('id','LIKE','%'.$search.'%');
                            ...
                            $query->orWhere('sub_name','LIKE','%'.$search.'%');
    ...
    public function ExportExcel(Request $request) 
    {
        ...
        $data=array();
        $array_column=array(
                                'ID','Name','Sub Name','Module Status','Created Date');
        array_push($data, $array_column);
        $inv=$this->CategoryQuery($request);
        foreach($inv as $voi):
            $inv_arry=array(
                                $voi->id,$voi->name,$voi->sub_name,$voi->module_status,formatDate($voi->created_at));
    ...
    public function ExportPDF(Request $request)
    {
        ...
        $html="<table class='table table-bordered' style='width:100%;'>
                ...
                <th class='text-center' style='font-size:12px;'>ID</th>
                            ...
                            <th class='text-center' style='font-size:12px;' >Sub Name</th>
                ...
                <tbody>";
                    ...
                    foreach($inv as $voi):
                        ...
                        <td style='font-size:12px;' class='text-center'>".$voi->sub_name."</td>
